...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <%= Html.Telerik().Grid<Mon1.Models.asa>(Model)
        ...
        .Columns(col =>
        {
            col.Bound(c => c.businessowner).Title("Owner").Width(100);
            col.Bound(c => c.nodetype).Title("NodeType").Width(100);
            col.Bound(c => c.framename).Title("Frame").Width(150);
            col.Bound(c => c.servername).Title("Server").Width(150);
            col.Bound(c => c.environment).Title("Environment").Width(80);
            col.Bound(c => c.os).Title("OS").Width(100);
            col.Bound(c => c.ismonitored).Title("IsMonitored?").Width(50);
            col.Bound(c => c.toolname).Title("Tool").Width(100);
            col.Bound(c => c.whyunmonitored).Title("WhyUnmonitored").Width(80);
            col.Bound(c => c.lastupdated).Title("AsOf").Format("{0:MM/dd/yy}").Width("400");
